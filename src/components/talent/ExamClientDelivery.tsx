...
export function ExamClientDelivery({ requirementId, questions, missionBrief, positionName, coreTasks }: Props) {
    ...
    <div className="flex flex-col h-full overflow-hidden bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between flex-shrink-0 shadow-sm">
        <div className="flex items-center gap-5">
          <div>
            <p className="text-[10px] text-slate-400 uppercase tracking-wider">结果交付式考核</p>
          </div>
     ...
     <button
              ...
              className="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-sm font-bold transition-colors shadow-sm"
            >
              确认提交 →
            </button>
          </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 bg-white border-r border-slate-200 overflow-y-auto">
          <div className="p-5 space-y-5">
            {positionName && (
              <div>
                <p className="text-[10px] font-bold text-amber-600 uppercase mb-1.5">▸ 项目名称</p>
            ...
            {coreTasks && (
              <div>
                <p className="text-[10px] font-bold text-amber-600 uppercase mb-1.5">▸ 核心任务</p>
          ...
          {questions.map((q, i) => (
            <div
              ...
              className={`bg-white rounded-2xl border transition-all ${
                activeQ === i ? "border-amber-300 shadow-md shadow-amber-50" : "border-slate-200"
              }`}
            >
              {/* Question header */}
              <div
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0 mt-0.5">
                      {q.seq}
                    </span>
                    <div>
              ...
              <div className="p-5 space-y-4">
                ...
                <div>
                  <textarea
                    ...
                    rows={6}
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-4 text-sm text-slate-700 outline-none focus:border-amber-300 focus:bg-white transition-colors resize-none placeholder:text-slate-400"
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-6 space-y-2.5 max-h-[55vh] overflow-y-auto">
              ...
              <div className="pt-3 border-t border-slate-100 mt-3">
                ...
                {[
                  { key: "check_format", label: "答案格式符合交付要求" },
      ...
      {showProfileDialog && (
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100">
              <h3 className="text-lg font-bold text-slate-800">上传相关资料</h3>
              <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  className="border-2 border-dashed border-slate-300 hover:border-amber-400 rounded-xl p-4 transition-colors cursor-pointer"
                >
                  <input
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {profileFiles.map((f, i) => (
                      <div key={i} className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                        <span className="text-xs text-amber-700 max-w-[200px] truncate">{f.name}</span>
                        <button
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm text-slate-700 outline-none focus:border-amber-300 focus:bg-white transition-colors resize-none placeholder:text-slate-400"
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex gap-3 justify-end">
              ...
              <button
                onClick={saveProfile}
                className="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-sm font-bold transition-colors"
              >
                确认提交
              </button>
            </div>
